(* A compilation unit is a collection of labeled, global data. It is
   processed by the assembler to produce an object file.  Author:
   Prof. Santosh Nagarakatte, based on Prof. Steve Zdancewic's code *)
